...
**Teaching Ethics:** Use [robots.txt checker](https://www.robotstxt.org/robotstxt.html) to review the "language" of this file
...
large_data <- data.table::fread(here::here("Data", "large_file.csv"))
...
# Read large parquet file
huge_data <- arrow::open_dataset("huge_file.parquet")
