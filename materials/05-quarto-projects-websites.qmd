...
format: 
  revealjs:
    footer: "[Teaching Intermediate R](https://atheobold.github.io/intermediate-r)"
...
::: {.centered}
![](images/05-rstudio-project.png){fig-alt="A translucent blue cube with a capital R in the center. The image is the logo of an RStudio project." width=40%}
